...
class RetryIncorrectWordView(private val viewModel: RetryIncorrectWordViewModel) {
    ...
    fun show() {
        val incorrectQuiz = RankingRepository.profile.incorrectQuiz
        ...
        // 유저 아이디
        val userId = RankingRepository.profile.userId
        // 문제 로드
    ...
    private fun selectQuizCounter(): Int {
        val incorrectSize = RankingRepository.profile.incorrectQuiz.size
