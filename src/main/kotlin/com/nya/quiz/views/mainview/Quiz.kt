...
//        viewModel.setTimeLimit(timeLimit)
    ...
    private fun solveQuiz(quizList: List<QuizWord>){
        ...
        val fileCorrect = RankingRepository.profile.correctCount
        val fileTotalQuiz = RankingRepository.profile.correctCount + RankingRepository.profile.incorrectCount
        val correctRate = viewModel.calculateCorrectRate(fileCorrect,fileTotalQuiz)
        viewModel.saveCalculateCorrectRate(correctRate)

        RankingRepository.updateRanking(RankingRepository.profile)
    }
